  ...
  return (
    <div id="splash-page">
      ...
      <div id="second-section" className="splash-section">
        <div id="sub-sec-1" className="sub-section-with-bg">
          <div className="message-sub-sec">
            <p>Write down anything that you need to remember</p>
          </div>
        </div>
        <div id="sub-sec-2" className="sub-section-with-bg">
          <div className="message-sub-sec">
            <p>Stay on top of tasks with a dedicated Checklist</p>
          </div>
        </div>
        <div id="sub-sec-3" className="sub-section-with-bg">
          <div className="message-sub-sec">
            <p>Keep track your events</p>
          </div>
        </div>
      </div>
      ...
      <div id="display-section" className="splash-section">
        ...
        <div id="sub-sec-21" className="sub-section">
          <div className="ui-example">
            {" "}
            <img src={require("./../../images/note_splash.png")} />
          </div>
        ...
        <div id="sub-sec-22" className="sub-section">
          ...
          <div className="ui-example">
            {" "}
            <img src={require("./../../images/checklist_splash.png")} />
          </div>
        </div>
        <div id="sub-sec-23" className="sub-section">
          <div className="ui-example">
            <img src={require("./../../images/calendar_splash.png")} />
          </div>
          <div className="indicator">
